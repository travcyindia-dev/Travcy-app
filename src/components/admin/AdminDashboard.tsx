...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ agencies, onVerify, onLogout }) => {
  ...
  const activeAgenciesCount = agencies.filter(a => a.verified && a.paid).length;
